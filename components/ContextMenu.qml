...
MouseArea {
    ...
    Menu {
        ...
        background: Rectangle {
            border.color: ScalaComponents.Style.buttonBackgroundColorDisabledHover
            border.width: 1
            radius: 2
            color: ScalaComponents.Style.blackTheme ? ScalaComponents.Style.buttonBackgroundColorDisabled : "#E5E5E5"
        }
        ...
        ScalaComponents.ContextMenuItem {

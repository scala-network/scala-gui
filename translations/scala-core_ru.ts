...
<context>
    ...
    <message>
        ...
        <translation>Это облегчит отправку и получение Scala и снизит количество ошибок при ручном вводе адресов.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>ВНИМАНИЕ! Не используйте ваши ключи Scala на другом форке, особенно, ЕСЛИ форк не имеет средств защиты от повторного использования ключей. Это может нанести ущерб вашей конфиденциальности.</translation>
    </message>
    <message>
        ...
        <translation>ВНИМАНИЕ: Копирование вашей мнемонической фразы в буфер обмена может сопровождаться перехватом этих данных различным вредоносным программным обеспечением, которое отправит вашу мнемонику злоумышленнику, после чего ваши Scala могут быть украдены. Пожалуйста, вводите вашу мнемоническую фразу вручную с клавиатуры.</translation>
    </message>
    <message>
...
Mining also gives you a small chance to earn some Scala. Your computer will create hashes looking for block solutions. If you find a block, you will get the associated reward. Good luck!</source>
        <translation>Майнинг на вашем компьютере помогает укрепить сеть Scala. Чем больше людей занимаются майнингом, тем сложнее атаковать сеть.

Также майнинг дает вам потенциальный шанс заработать немного Scala. Ваш компьютер будет создавать хэши в попытках найти блок. Если вы найдете блок в процессе майнинга, вы получите соответствующую награду. Удачи!</translation>
    </message>
    <message>
        <location filename="../pages/Mining.qml" line="76"/>
    ...
    <message>
        ...
        <translation>Использовать половину (рекомендуется)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Переключиться на другой публичный удаленный узел</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>QR-код скопирован в буфер обмена</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Скопировать запрос платежа в буфер обмена</translation>
    </message>
    <message>
        <location filename="../pages/Receive.qml" line="199"/>
        <source>Payment request copied to clipboard</source>
        <translation>Запрос платежа скопирован в буфер обмена</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Расшифровка платежа (товар, услуга, пожертвование) (необязательно)</translation>
    </message>
    <message>
        ...
        <translation>Виден отправителю</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Ваше имя, компания или веб-сайт (необязательно)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>QR-код сохранен в </translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Встроенная версия Scala: </translation>
    </message>
    <message>
...
Старый файл, содержащий кеш кошелька будет переименован и сможет быть восстановлен позднее.
    ...
    <message>
        ...
        <translation>Пожертвовать Scala</translation>
    </message>
    <message>
        <location filename="../pages/settings/SettingsInfo.qml" line="412"/>
        <source>Donation to Scala Core Team</source>
        <translation>Пожертвование Основной команде Scala</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>Отображать имя кошелька в строке заголовка</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Использовать сторонний узел для подключения к сети Scala. Менее безопасно, но более быстро и удобно.</translation>
    </message>
    <message>
        ...
        <translation>Чтобы получить список удаленных узлов, введите &apos;Scala remote node&apos; в вашем любимом поисковике. Пожалуйста, убедитесь, что выбранному узлу можно доверять.</translation>
    </message>
    <message>
...
Вы можете изменить пароль в настройках кошелька.</translation>
    ...
    <message>
        ...
        <translation>Получайте Scala для вашего бизнеса, легко.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>На этой странице можно взаимодействовать с общей базой данных RingDB. Эта база данных предназначается для использования кошельками Scala или их клонов, которые смогут повторно использовать ключи Scala.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Для того чтобы скрыть какие входы в транзакциях Scala потрачены, третья сторона не должна сообщать какие входы в кольце уже задействованы в трате. Ведь если это сделать, то это ослабит защиту, обеспечиваемую кольцевыми подписями. Если известно, что все, кроме одного из входов, уже потрачены, то фактически трата входа становится очевидной, тем самым аннулируется эффект кольцевых подписей, одного из трех основных уровней защиты конфиденциальности Scala.&lt;br&gt;Чтобы помочь транзакциям избежать траты этих входов, можно использовать список известных израсходованных выходов, чтобы избежать их использования в новых транзакциях. Такой список поддерживается проектом Scala и доступен на веб-сайте getscala.org, и вы можете импортировать этот список здесь.&lt;br&gt;Кроме того, вы можете просканировать блокчейн Scala (и его клонов) самостоятельно, используя инструмент scala-blockchain-mark-spent-outputs, чтобы создать список известных потраченых выходов.&lt;br&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Чтобы избежать аннулирования защиты, предоставляемой кольцевыми подписями Scala, выход не должен быть потраченным с другими значениями размера кольца и на других блокчейнах. Хотя, как правило, это не является проблемой, в некоторых случаях повторное использование ключей Scala позволяет потратить существующие выходы. В таких случаях вам необходимо позаботиться, чтобы эти существующие выходы использовали одно и то же кольцо в обеих блокчейнах.&lt;br&gt;Это может быть сделано автоматически с помощью любого программного обеспечения для повторного использования ключей от Scala-клонов, и даже если эти клоны не предоставляют подобную защиту, вы все еще можете проверить, что ваши транзакции защищены, путем ручного введения размера кольца на этой странице, которая позволит вам потратить ваши Scala безопасно.&lt;br&gt;Если вы не используете программное обеспечения от Scala-клонов, вам ничего не нужно делать, так как все будет сделано автоматически.&lt;br&gt;</translation>
    </message>
    <message>
        ...
        <translation>Здесь записываются кольца, используемые выходами, проводимыми на Scala, в цепочке повторного использования ключей, так что одно и то же кольцо можно использовать повторно, чтобы избежать проблем с конфиденциальностью.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введите адрес Scala (например: 44AFFq5kSiGBoZ...)</translation>
    </message>
    <message>
...
Подтверждающее сообщение:
    ...
    <message>
        ...
        <translation>Scala успешно отправлены</translation>
    </message>
    <message>
...
Пожалуйста, обновитесь или подключитесь к другому демону</translation>
    ...
    <message>
        ...
        <translation>Отправляемая сумма: %1 XLA. Пожалуйста, подождите ~%2 минут чтобы весь ваш баланс стал доступен для отправки.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Потратить XLA из холодного (оффлайн) кошелька</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Требуется для того, чтобы холодные кошельки подписывали соответствующие образы ключей</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Выходы успешно экспортированы в файл</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Образы ключей успешно экспортированы в файл</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Адрес Scala</translation>
    </message>
    <message>
...
Для зарезервированных доказательств вам не нужно указывать идентификатор транзакции или адрес.</translation>
    ...
    <message>
        ...
        <translation>Сумма XLA (только для зарезервированных доказательств)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Доступна новая версия Scala v%1.</translation>
    </message>
    <message>
        <location filename="../components/UpdateDialog.qml" line="98"/>
        <source>Please visit getscala.org for details</source>
        <translation>Пожалуйста, посетите getscala.org для получения дополнительной информации</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Выберите аппаратный кошелёк</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Модель аппаратного кошелька</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Чтобы обмениваться данными с сетью Scala, ваш кошелек должен быть подключен к узлу Scala. Для лучшей конфиденциальности рекомендуется запустить свой собственный узел.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Кроме того, вы можете указать узел начальной загрузки, чтобы немедленно начать использование Scala.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Добро пожаловать в Scala</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Выберете эту опцию, если вы впервые пользуетесь Scala.</translation>
    </message>
    <message>
        <location filename="../wizard/WizardHome.qml" line="104"/>
    ...
    <message>
        ...
        <translation>Создать новый кошелек, подключившись к вашему аппаратному кошельку Scala.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Этот режим идеально подходит для работы с небольшими суммами Scala. У вас есть доступ ко всем основным функциям для совершения транзакций и управления ими. Программа автоматически подключится к сети Scala, чтобы вы немедленно могли начать использование Scala.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Создавайте портативный кошелек и используйте его на любом ПК. Включите данный функционал, если вы установили Scala на USB-накопитель, внешний диск или любой другой портативный носитель.</translation>
    </message>
    <message>
...
If you don&apos;t have the option to run your own node, there&apos;s an option to connect to a remote node.</source>
        <translation>Чтобы обмениваться данными с сетью Scala, ваш кошелек должен быть подключен к узлу Scala. Для лучшей конфиденциальности рекомендуется запустить свой собственный узел.
...
<context>
    ...
    <message>
        ...
        <translation>Язык мнемонической фразы</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Этот адрес получил %1 XLA, с %2 подтверждениями.</translation>
    </message>
    <message>
        <location filename="../main.qml" line="1066"/>
        <source>Good signature</source>
    ...
    <message>
        ...
        <translation>Вы бы хотели, чтобы записи Scala GUI производились на рабочий стол?</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Этот адрес получил %1 XLA, но транзакция все еще не подтверждена майнерами</translation>
    </message>
    <message>

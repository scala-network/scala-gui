...
function getApproximateBlockchainHeight(_date, _nettype){
    var scalaBirthTime = _nettype == "Mainnet" ? 1596258914 : _nettype == "Testnet" ? 1692005445 : 1691411928;
    var secondsPerBlock = 120;
    ...
    if (requestedTime < scalaBirthTime){
        ...
        approxBlockchainHeight = Math.floor((requestedTime - scalaBirthTime) / secondsPerBlock);
